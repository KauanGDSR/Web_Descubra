...
export const metadata: Metadata = {
  ...
  description: 'O DescubraHub incentiva a aprendizagem profissional e insere adolescentes e jovens de Minas Gerais em situação de vulnerabilidade no mercado de trabalho protegido.',
  keywords: ['DescubraHub', 'Aprendizagem Profissional', 'Minas Gerais', 'MPMG', 'Inclusão Social', 'Jovens Aprendizes'],
  openGraph: {
    type: 'website',
    url: 'https://programadescubra.mg.gov.br/',
    title: 'DescubraHub - Trabalho Protegido para Jovens em Minas Gerais',
